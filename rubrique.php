...
<body>
    ...
    <nav>
        <ul>
            ...
            <li><a href="espace.php" id="entreprisesLink">Gérer les rubriques</a></li>
...
#message {
    ...
    <title>Tableau de règles et de rubriques</title>
    <style>
        table {
...
<body>
    <table>
        ...
        <tbody>
            ...
            $sql = "SELECT idregle, designation AS rubrique, formule AS regles FROM regle ";
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    echo "<tr>";
                    echo "<td>".$row["idregle"]."</td>";
                    echo "<td>".$row["rubrique"]."</td>";
                    echo "<td>".$row["regles"]."</td>";
                    echo "<td><a href='modifier_regle.php?id=".$row["idregle"]."'><img src='modifier.png' alt='modifier' class='icon'></a></td>";
                    echo "<td><a href='supprimer_regle.php?id=".$row["idregle"]."'><img src='supprimer1.png' alt='Supprimer' class='icon'></a></td>";
                    echo "</tr>";
                }
            } else {
